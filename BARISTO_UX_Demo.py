...
__date__ =    "Late Updated: 2018-03-09"
	...
	switch(interfaceName):
		case HELLO_AUDIO:
			if DEBUG_STATEMENTS_ON: print("Hello, Is this your first time with us?")
	  			#TO-DO: How do I loop or select next sentence to say?
...
def setupGPIO():
	...
	GPIO.setup(EMIC_SIN_PIN, GPIO.SERIAL, pull_up_down=GPIO.PUD_UP)
	GPIO.setup(EMIC_SPEAK_PIN, GPIO.OUT)
	GPIO.setup(EMIC_SOUT_PIN, GPIO.SERIAL)
	#https://spellfoundry.com/2016/05/29/configuring-gpio-serial-port-raspbian-jessie-including-pi-3/
	#GPIO.setup(EMIC_SOUT_PIN, GPIO.I2C)
...
if __name__ == "__main__":
	...
	serialPort1 = configureSerialPort()
	setupGPIO()
	...
	try:
		...
		while True:
			...
			range(2): #Repeat "Hello, Is this your first time with us?"  twice
